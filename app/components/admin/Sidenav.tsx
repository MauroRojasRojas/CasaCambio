				...
				<nav className='px-4 mt-2 text-[15px] font-semibold flex flex-col gap-2'>
					...
					<Link href='/operacion'>
						<button
                            ...
                            ${pathname === '/operacion' ? 'bg-blue-100 text-[#0053A4]' : 'hover:bg-[#F5F7FF] hover:text-[#0053A4] text-[#02254A]'}
                        `}
					...
					{/* HISTORIAL */}
					<Link href='/operacion/historial'>
						<button
							className={`
                            flex items-center w-full px-4 py-3 rounded-xl
                            transition-all cursor-pointer gap-3 font-semibold
                            ${pathname === '/operacion/historial' ? 'bg-blue-100 text-[#0053A4]' : 'hover:bg-[#F5F7FF] hover:text-[#0053A4] text-[#02254A]'}
                        `}
							onClick={() => setIsMenuOpen(false)}
						>
							<div className='w-6 flex justify-center'>
					...
					{/* CUENTAS */}
					<Link href='/operacion/cuentas'>
						<button
							className={`
                            flex items-center w-full px-4 py-3 rounded-xl
                            transition-all cursor-pointer gap-3 font-semibold
                            ${pathname === '/operacion/cuentas' ? 'bg-blue-100 text-[#0053A4]' : 'hover:bg-[#F5F7FF] hover:text-[#0053A4] text-[#02254A]'}
                        `}
							onClick={() => setIsMenuOpen(false)}
						>
							<div className='w-6 flex justify-center'>
