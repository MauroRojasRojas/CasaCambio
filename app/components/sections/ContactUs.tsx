					...
					<div className='bg-white p-8 rounded-2xl shadow-lg'>
						...
						<form className='space-y-4'>
							<div>
								...
								<input
									type='text'
									className='w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-[#0053A4] focus:border-transparent'
							...
							<button type='submit' className='w-full px-6 py-3 bg-[#0053A4] text-white font-semibold rounded-lg hover:bg-[#003f7c] transition-colors'>
								Enviar Mensaje
							</button>
						</form>
					</div>
