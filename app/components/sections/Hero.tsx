				...
				<div className='max-w-[1800px] mx-auto'>
					<div className='grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-8 lg:gap-10'>
						...
						<div className='lg:col-span-8 flex flex-col lg:flex-row items-center lg:items-end gap-4 lg:gap-0 pt-4 md:pt-6 lg:pt-8'>
							{/* ===== TEXTO ===== */}
							<div className='flex-shrink-0 text-center lg:text-left lg:pb-8 pb-4'>
							...
							{/* ===== IMAGEN WOMENS ===== */}
							<div className='flex-shrink-0 hidden lg:flex -ml-10 items-end'>
								<img src='/assets/womens.png' alt='Equipo Dollariza' className='h-[320px] lg:h-[400px] 4k:h-[500px] block' />
							</div>
						</div>
				...
				<div className='relative max-w-[1800px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 4k:px-16 py-2 md:py-4 lg:py-6'>
					<div className='grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6'>
						...
						<div className='flex justify-center md:justify-start items-center'>
							<span className='inline-block bg-white text-[#02254A] font-bold px-4 sm:px-6 py-2 rounded-lg text-xs sm:text-sm shadow-sm text-center'>
						...
						<div className='flex justify-center md:justify-end gap-4 sm:gap-6 lg:gap-8'>
							...
							<Image
								src='/assets/pichincha.svg'
								width={72}
								height={72}
								className='object-contain rounded-2xl w-12 h-12 sm:w-16 sm:h-16 lg:w-[72px] lg:h-[72px]'
								alt='Pichincha'
							/>
						</div>
					</div>
