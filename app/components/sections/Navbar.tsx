			...
			<div className='max-w-[1800px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 4k:px-16 py-3'>
				...
				<div className='flex items-center justify-between'>
					...
					<div className='flex-1 flex items-center justify-start md:justify-center gap-3'>
						<Image src='/icons/logomejorado.png' alt='Dollariza' width={50} height={50} priority className='w-auto h-10 md:h-12 lg:h-[50px] object-contain' />
				...
				{isOpen && (
					<div className='md:hidden mt-4 pb-4 border-t border-slate-200'>
						<nav className='flex flex-col gap-4'>
							{/* Main nav items */}
							<button className='text-left hover:text-[#0053A4] font-semibold cursor-pointer' onClick={() => router.push('/quienes-somos')}>
								¿Quiénes somos?
							</button>
