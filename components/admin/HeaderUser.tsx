		...
		<header className='w-full bg-white h-16 shadow-sm px-4 sm:px-10 flex items-center justify-between border-b border-slate-200'>
			...
			<div className='flex items-center'>
				...
				<button
					...
					className='md:hidden p-2 text-[#02254A] hover:bg-gray-100 rounded'
				>
					☰
				</button>
			...
			<div className='flex items-center gap-5 relative ml-auto'>
				...
				>
					<span className='font-semibold text-[#02254A] hidden sm:inline'>
						{user?.fullName}
					</span>

					<img
						src='/icons/low-arrow.png'
						alt='arrow'
				...
				{showMenu && (
					<div className='absolute right-0 top-12 bg-white border border-slate-200 rounded-lg shadow-lg w-56 z-50'>
						...
						<div className='px-6 py-4 border-b border-slate-200 flex items-center gap-3'>
							...
							<span className='font-semibold text-[#02254A]'>
								{user?.fullName}
							</span>
						</div>
