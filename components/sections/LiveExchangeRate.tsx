...
import { getTasaActual, TasaCambio, calcularMinutosDesdeActualizacion } from '@/lib/services/tasaCambioService';
...
export default function LiveExchangeRate() {
	...
	const cargarTasas = async () => {
		try {
			...
			setMinutosActualizacion(calcularMinutosDesdeActualizacion(tasasActuales.fecha_hora));
			setLoading(false);
		} catch (err) {
